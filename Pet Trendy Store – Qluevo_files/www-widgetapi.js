...
return a}
var Xb={pa:"allow-forms",qa:"allow-modals",ra:"allow-orientation-lock",sa:"allow-pointer-lock",ta:"allow-popups",ua:"allow-popups-to-escape-sandbox",va:"allow-presentation",wa:"allow-same-origin",xa:"allow-scripts",ya:"allow-top-navigation",za:"allow-top-navigation-by-user-activation"},Zb=Ya(function(){return Yb()});
...
function b(n){for(var r=g,p=0;64>p;p+=4)r[p/4]=n[p]<<24|n[p+1]<<16|n[p+2]<<8|n[p+3];for(p=16;80>p;p++)n=r[p-3]^r[p-8]^r[p-14]^r[p-16],r[p]=(n<<1|n>>>31)&4294967295;n=e[0];var v=e[1],y=e[2],F=e[3],Q=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var pa=F^v&(y^F);var Ua=1518500249}else pa=v^y^F,Ua=1859775393;else 60>p?(pa=v&y|F&(v|y),Ua=2400959708):(pa=v^y^F,Ua=3395469782);pa=((n<<5|n>>>27)&4294967295)+pa+Q+Ua+r[p]&4294967295;Q=F;F=y;y=(v<<30|v>>>2)&4294967295;v=n;n=pa}e[0]=e[0]+n&4294967295;e[1]=e[1]+v&4294967295;
...
L.prototype.then=function(a,b,c){return Pc(this,Ha(a)?a:null,Ha(b)?b:null,c)};
L.prototype.$goog_Thenable=!0;L.prototype.cancel=function(a){if(0==this.f){var b=new Qc(a);rc(function(){Rc(this,b)},this)}};
function Rc(a,b){if(0==a.f)if(a.h){var c=a.h;if(c.g){for(var d=0,e=null,f=null,g=c.g;g&&(g.h||(d++,g.f==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.f&&1==d?Rc(c,b):(f?(d=f,d.next==c.i&&(c.i=d),d.next=d.next.next):Sc(c),Tc(c,e,3,b)))}a.h=null}else Kc(a,3,b)}
function Uc(a,b){a.g||2!=a.f&&3!=a.f||Vc(a);a.i?a.i.next=b:a.g=b;a.i=b}
function Pc(a,b,c,d){var e=Nc(null,null,null);e.f=new L(function(f,g){e.g=b?function(k){try{var h=b.call(d,k);f(h)}catch(l){g(l)}}:f;
e.onRejected=c?function(k){try{var h=c.call(d,k);void 0===h&&k instanceof Qc?g(k):f(h)}catch(l){g(l)}}:g});
e.f.h=a;Uc(a,e);return e.f}
L.prototype.A=function(a){this.f=0;Kc(this,2,a)};
L.prototype.F=function(a){this.f=0;Kc(this,3,a)};
function Kc(a,b,c){if(0==a.f){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;a:{var d=c,e=a.A,f=a.F;if(d instanceof L){Uc(d,Nc(e||Ea,f||null,a));var g=!0}else{if(d)try{var k=!!d.$goog_Thenable}catch(l){k=!1}else k=!1;if(k)d.then(e,f,a),g=!0;else{if(Ia(d))try{var h=d.then;if(Ha(h)){Wc(d,h,e,f,a);g=!0;break a}}catch(l){f.call(a,l);g=!0;break a}g=!1}}}g||(a.m=c,a.f=b,a.h=null,Vc(a),3!=b||c instanceof Qc||Xc(a,c))}}
function Wc(a,b,c,d,e){function f(h){k||(k=!0,d.call(e,h))}
function g(h){k||(k=!0,c.call(e,h))}
var k=!1;try{b.call(a,g,f)}catch(h){f(h)}}
function Vc(a){a.l||(a.l=!0,rc(a.s,a))}
function Sc(a){var b=null;a.g&&(b=a.g,a.g=b.next,b.next=null);a.g||(a.i=null);return b}
L.prototype.s=function(){for(var a;a=Sc(this);)Tc(this,a,this.f,this.m);this.l=!1};
function Tc(a,b,c,d){if(3==c&&b.onRejected&&!b.h)for(;a&&a.j;a=a.h)a.j=!1;if(b.f)b.f.h=null,Yc(b,c,d);else try{b.h?b.g.call(b.context):Yc(b,c,d)}catch(e){Zc.call(null,e)}kc(Mc,b)}
function Yc(a,b,c){2==b?a.g.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function Xc(a,b){a.j=!0;rc(function(){a.j&&Zc.call(null,b)})}
var Zc=lc;function Qc(a){Qa.call(this,a)}
E(Qc,Qa);Qc.prototype.name="cancel";function M(a){ac.call(this);this.m=1;this.j=[];this.l=0;this.f=[];this.g={};this.s=!!a}
...
function $c(a,b,c){var d=ad;if(a=d.g[a]){var e=d.f;(a=Ta(a,function(f){return e[f+1]==b&&e[f+2]==c}))&&d.J(a)}}
...
q.P=function(a,b){var c=this.g[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.s)for(e=0;e<c.length;e++){var g=c[e];bd(this.f[g+1],this.f[g+2],d)}else{this.l++;try{for(e=0,f=c.length;e<f;e++)g=c[e],this.f[g+1].apply(this.f[g+2],d)}finally{if(this.l--,0<this.j.length&&0==this.l)for(;c=this.j.pop();)this.J(c)}}return 0!=e}return!1};
function bd(a,b,c){rc(function(){a.apply(b,c)})}
q.clear=function(a){if(a){var b=this.g[a];b&&(G(b,this.J,this),delete this.g[a])}else this.f.length=0,this.g={}};
q.M=function(){M.D.M.call(this);this.clear();this.j.length=0};function cd(a){this.f=a}
cd.prototype.set=function(a,b){void 0===b?this.f.remove(a):this.f.set(a,Jc(b))};
cd.prototype.get=function(a){try{var b=this.f.get(a)}catch(c){return}if(null!==b)try{return JSON.parse(b)}catch(c){throw"Storage: Invalid value was encountered";}};
cd.prototype.remove=function(a){this.f.remove(a)};function dd(a){this.f=a}
E(dd,cd);function ed(a){this.data=a}
function fd(a){return void 0===a||a instanceof ed?a:new ed(a)}
dd.prototype.set=function(a,b){dd.D.set.call(this,a,fd(b))};
dd.prototype.g=function(a){a=dd.D.get.call(this,a);if(void 0===a||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
dd.prototype.get=function(a){if(a=this.g(a)){if(a=a.data,void 0===a)throw"Storage: Invalid value was encountered";}else a=void 0;return a};function gd(a){this.f=a}
E(gd,dd);gd.prototype.set=function(a,b,c){if(b=fd(b)){if(c){if(c<C()){gd.prototype.remove.call(this,a);return}b.expiration=c}b.creation=C()}gd.D.set.call(this,a,b)};
gd.prototype.g=function(a){var b=gd.D.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<C()||c&&c>C())gd.prototype.remove.call(this,a);else return b}};function hd(){}
;function id(){}
E(id,hd);id.prototype.clear=function(){var a=Ec(this.B(!0)),b=this;G(a,function(c){b.remove(c)})};function jd(a){this.f=a}
E(jd,id);q=jd.prototype;q.isAvailable=function(){if(!this.f)return!1;try{return this.f.setItem("__sak","1"),this.f.removeItem("__sak"),!0}catch(a){return!1}};
...
q.key=function(a){return this.f.key(a)};function kd(){var a=null;try{a=window.localStorage||null}catch(b){}this.f=a}
E(kd,jd);function ld(a,b){this.g=a;this.f=null;if(tb&&!(9<=Number(Fb))){md||(md=new Fc);this.f=md.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),md.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
E(ld,id);var nd={".":".2E","!":".21","~":".7E","*":".2A","'":".27","(":".28",")":".29","%":"."},md=null;function od(a){return"_"+encodeURIComponent(a).replace(/[.!~*'()%]/g,function(b){return nd[b]})}
q=ld.prototype;q.isAvailable=function(){return!!this.f};
q.set=function(a,b){this.f.setAttribute(od(a),b);pd(this)};
q.get=function(a){a=this.f.getAttribute(od(a));if("string"!==typeof a&&null!==a)throw"Storage mechanism: Invalid value was encountered";return a};
q.remove=function(a){this.f.removeAttribute(od(a));pd(this)};
...
return d};
q.clear=function(){for(var a=this.f.XMLDocument.documentElement,b=a.attributes.length;0<b;b--)a.removeAttribute(a.attributes[b-1].nodeName);pd(this)};
function pd(a){try{a.f.save(a.g)}catch(b){throw"Storage mechanism: Quota exceeded";}}
;function qd(a,b){this.g=a;this.f=b+"::"}
E(qd,id);qd.prototype.set=function(a,b){this.g.set(this.f+a,b)};
qd.prototype.get=function(a){return this.g.get(this.f+a)};
qd.prototype.remove=function(a){this.g.remove(this.f+a)};
qd.prototype.B=function(a){var b=this.g.B(!0),c=this,d=new Bc;d.next=function(){for(var e=b.next();e.substr(0,c.f.length)!=c.f;)e=b.next();return a?e.substr(c.f.length):c.g.get(e)};
return d};var N=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};D("yt.config_",N);function rd(a){var b=arguments;1<b.length?N[b[0]]=b[1]:1===b.length&&Object.assign(N,b[0])}
function O(a,b){return a in N?N[a]:b}
;var sd=[];function td(a){sd.forEach(function(b){return b(a)})}
function ud(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){vd(b),td(b)}}:a}
function vd(a){var b=B("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=O("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),rd("ERRORS",b))}
function wd(a){var b=B("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=O("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),rd("ERRORS",b))}
;var xd=0;D("ytDomDomGetNextId",B("ytDomDomGetNextId")||function(){return++xd});var yd={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
function zd(a){this.type="";this.state=this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.metaKey=this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;this.changedTouches=this.touches=null;try{if(a=a||window.event){this.event=a;for(var b in a)b in yd||(this[b]=a[b]);var c=a.target||a.srcElement;c&&3==c.nodeType&&(c=c.parentNode);this.target=c;var d=a.relatedTarget;if(d)try{d=d.nodeName?d:null}catch(e){d=null}else"mouseover"==
...
zd.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var ab=A.ytEventsEventsListeners||{};D("ytEventsEventsListeners",ab);var Ad=A.ytEventsEventsCounter||{count:0};D("ytEventsEventsCounter",Ad);
...
function Cd(a){a&&("string"==typeof a&&(a=[a]),G(a,function(b){if(b in ab){var c=ab[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Dd()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete ab[b]}}))}
var Dd=Ya(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function Ed(a,b,c){var d=void 0===d?{}:d;if(a&&(a.addEventListener||a.attachEvent)){var e=Bd(a,b,c,d);if(!e){e=++Ad.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(k){k=new zd(k);if(!Pb(k.relatedTarget,function(h){return h==a}))return k.currentTarget=a,k.type=b,c.call(a,k)}:function(k){k=new zd(k);
k.currentTarget=a;return c.call(a,k)};
g=ud(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Dd()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);ab[e]=[a,b,c,g,d]}}}
;function Fd(a,b){"function"===typeof a&&(a=ud(a));return window.setTimeout(a,b)}
function Gd(a){"function"===typeof a&&(a=ud(a));return window.setInterval(a,250)}
;function Hd(a){var b=[];Za(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];G(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function Id(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Array.isArray(b[f])?Xa(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(h){if("q"!=e[0]){var k=Error("Error decoding URL component");k.params={key:e[0],value:e[1]};vd(k)}}}return b}
function Jd(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=Id(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);b=a;a=Ub(e);a?(c=b.indexOf("#"),0>c&&(c=b.length),f=b.indexOf("?"),0>f||f>c?(f=c,e=""):e=b.substring(f+1,c),b=[b.substr(0,f),e,b.substr(c)],c=b[1],b[1]=a?c?c+"&"+a:a:c,a=b[0]+(b[1]?"?"+b[1]:"")+b[2]):a=b;return a+d}
;var Kd={};function Ld(a){return Kd[a]||(Kd[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Md={},Nd=[],ad=new M,Od={};function Pd(){for(var a=u(Nd),b=a.next();!b.done;b=a.next())b=b.value,b()}
function Qd(a,b){b||(b=document);var c=Wa(b.getElementsByTagName("yt:"+a));var d="yt-"+a;var e=b||document;d=e.querySelectorAll&&e.querySelector?e.querySelectorAll("."+d):Nb(d,b);d=Wa(d);return Va(c,d)}
function P(a,b){var c;"yt:"==a.tagName.toLowerCase().substr(0,3)?c=a.getAttribute(b):c=a?a.dataset?a.dataset[Ld(b)]:a.getAttribute("data-"+b):null;return c}
function Rd(a,b){ad.P.apply(ad,arguments)}
;function Sd(a){this.g=a||{};this.h=this.f=!1;a=document.getElementById("www-widgetapi-script");if(this.f=!!("https:"==document.location.protocol||a&&0==a.src.indexOf("https:"))){a=[this.g,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.replace("http://","https://"))}}
function R(a,b){for(var c=[a.g,window.YTConfig||{}],d=0;d<c.length;d++){var e=c[d][b];if(void 0!=e)return e}return null}
function Td(a,b,c){Ud||(Ud={},Ed(window,"message",Oa(a.i,a)));Ud[c]=b}
Sd.prototype.i=function(a){if(a.origin==R(this,"host")||a.origin==R(this,"host").replace(/^http:/,"https:")){try{var b=JSON.parse(a.data)}catch(c){return}this.h=!0;this.f||0!=a.origin.indexOf("https:")||(this.f=!0);if(a=Ud[b.id])a.s=!0,a.s&&(G(a.m,a.R,a),a.m.length=0),a.aa(b)}};
var Ud=null;function S(a){a=Vd(a);return"string"===typeof a&&"false"===a?!1:!!a}
function Wd(a,b){var c=Vd(a);return void 0===c&&void 0!==b?b:Number(c||0)}
function Vd(a){var b=O("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:O("EXPERIMENT_FLAGS",{})[a]}
;function Xd(){}
function Yd(a,b){return Zd(a,0,b)}
;function $d(){}
na($d,Xd);function Zd(a,b,c){isNaN(c)&&(c=void 0);var d=B("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):Fd(a,c||0)}
$d.prototype.start=function(){var a=B("yt.scheduler.instance.start");a&&a()};
$d.f=void 0;$d.g=function(){$d.f||($d.f=new $d)};
$d.g();var ae=A.ytPubsubPubsubInstance||new M,be=A.ytPubsubPubsubSubscribedKeys||{},ce=A.ytPubsubPubsubTopicToKeys||{},de=A.ytPubsubPubsubIsSynchronous||{};M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.J;M.prototype.publish=M.prototype.P;M.prototype.clear=M.prototype.clear;D("ytPubsubPubsubInstance",ae);D("ytPubsubPubsubTopicToKeys",ce);D("ytPubsubPubsubIsSynchronous",de);D("ytPubsubPubsubSubscribedKeys",be);var T=window,U=T.ytcsi&&T.ytcsi.now?T.ytcsi.now:T.performance&&T.performance.timing&&T.performance.now&&T.performance.timing.navigationStart?function(){return T.performance.timing.navigationStart+T.performance.now()}:function(){return(new Date).getTime()};var ee=Wd("initial_gel_batch_timeout",1E3),fe=Math.pow(2,16)-1,ge=null,he=0,ie=void 0,je=0,ke=0,le=0,me=!0,ne=A.ytLoggingTransportLogPayloadsQueue_||{};D("ytLoggingTransportLogPayloadsQueue_",ne);var oe=A.ytLoggingTransportGELQueue_||new Map;D("ytLoggingTransportGELQueue_",oe);var pe=A.ytLoggingTransportTokensToCttTargetIds_||{};D("ytLoggingTransportTokensToCttTargetIds_",pe);
function qe(){window.clearTimeout(je);window.clearTimeout(ke);ke=0;ie&&ie.isReady()?(re(oe),"log_event"in ne&&re(Object.entries(ne.log_event)),oe.clear(),delete ne.log_event):se()}
function se(){S("web_gel_timeout_cap")&&!ke&&(ke=Fd(qe,6E4));window.clearTimeout(je);var a=O("LOGGING_BATCH_TIMEOUT",Wd("web_gel_debounce_ms",1E4));S("shorten_initial_gel_batch_timeout")&&me&&(a=ee);je=Fd(qe,a)}
function re(a){var b=ie,c=Math.round(U());a=u(a);for(var d=a.next();!d.done;d=a.next()){var e=u(d.value);d=e.next().value;var f=e.next().value;e=cb({context:te(b.f||ue())});e.events=f;(f=pe[d])&&ve(e,d,f);delete pe[d];we(e,c);xe(b,"log_event",e,{retry:!0,onSuccess:function(){he=Math.round(U()-c)}});
me=!1}}
function we(a,b){a.requestTimeMs=String(b);S("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);var c=O("EVENT_ID",void 0);if(c){var d=O("BATCH_CLIENT_COUNTER",void 0)||0;!d&&S("web_client_counter_random_seed")&&(d=Math.floor(Math.random()*fe/2));d++;d>fe&&(d=1);rd("BATCH_CLIENT_COUNTER",d);c={serializedEventId:c,clientCounter:String(d)};a.serializedClientEventId=c;ge&&he&&S("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:ge,roundtripMs:String(he)});ge=c;he=0}}
function ve(a,b,c){if(c.videoId)var d="VIDEO";else if(c.playlistId)d="PLAYLIST";else return;a.credentialTransferTokenTargetId=c;a.context=a.context||{};a.context.user=a.context.user||{};a.context.user.credentialTransferTokens=[{token:b,scope:d}]}
;var ye=A.ytLoggingGelSequenceIdObj_||{};D("ytLoggingGelSequenceIdObj_",ye);function ze(a){var b=Ae;a=void 0===a?B("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(Be(b),Ce(b));b.ca_type="image";a&&(b.bid=a);return b}
function Be(a){var b={};b.dt=bc;b.flash="0";a:{try{var c=a.f.top.location.href}catch(f){a=2;break a}a=c?c===a.g.location.href?0:1:2}b=(b.frm=a,b);b.u_tz=-(new Date).getTimezoneOffset();var d=void 0===d?I:d;try{var e=d.history.length}catch(f){e=0}b.u_his=e;b.u_java=!!I.navigator&&"unknown"!==typeof I.navigator.javaEnabled&&!!I.navigator.javaEnabled&&I.navigator.javaEnabled();I.screen&&(b.u_h=I.screen.height,b.u_w=I.screen.width,b.u_ah=I.screen.availHeight,b.u_aw=I.screen.availWidth,b.u_cd=I.screen.colorDepth);
...
D("yt.ads_.signals_.getAdSignalsString",function(a){return Hd(ze(a))});C();var De="XMLHttpRequest"in A?function(){return new XMLHttpRequest}:null;
...
He=!1;
function Ie(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=a.match(Qb)[1]||null,e=J(a);d&&e?(d=c,c=a.match(Qb),d=d.match(Qb),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?J(c)==e&&(Number(c.match(Qb)[4]||null)||null)==(Number(a.match(Qb)[4]||null)||null):!0;d=S("web_ajax_ignore_global_headers_if_set");for(var f in Fe)e=O(Fe[f]),!e||!c&&J(a)||d&&void 0!==b[f]||(b[f]=e);if(c||!J(a))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(c||!J(a))&&(f="undefined"!=typeof Intl?(new Intl.DateTimeFormat).resolvedOptions().timeZone:
null)&&(b["X-YouTube-Time-Zone"]=f);if(c||!J(a))b["X-YouTube-Ad-Signals"]=Hd(ze(void 0));return b}
function Je(a){var b=window.location.search,c=J(a),d=Rb(a.match(Qb)[5]||null);d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Id(b),f={};G(Ge,function(g){e[g]&&(f[g]=e[g])});
return Jd(a,f||{},!1)}
...
b.X&&0<b.timeout&&(f=Fd(function(){e||(e=!0,window.clearTimeout(f),b.X.call(b.context||A))},b.timeout))}else Ne(a,b)}
function Ne(a,b){var c=b.format||"JSON";a=Le(a,b);var d=Me(a,b),e=!1,f=Oe(a,function(h){if(!e){e=!0;k&&window.clearTimeout(k);a:switch(h&&"status"in h?h.status:-1){case 200:case 201:case 202:case 203:case 204:case 205:case 206:case 304:var l=!0;break a;default:l=!1}var m=null,n=400<=h.status&&500>h.status,r=500<=h.status&&600>h.status;if(l||n||r)m=Pe(a,c,h,b.Ca);if(l)a:if(h&&204==h.status)l=!0;else{switch(c){case "XML":l=0==parseInt(m&&m.return_code,10);break a;case "RAW":l=!0;break a}l=!!m}m=m||
...
if(b.H&&0<b.timeout){var g=b.H;var k=Fd(function(){e||(e=!0,f.abort(),window.clearTimeout(k),g.call(b.context||A,f))},b.timeout)}}
function Le(a,b){b.Ga&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=O("XSRF_FIELD_NAME",void 0),d=b.na;d&&(d[c]&&delete d[c],a=Jd(a,d||{},!0));return a}
function Me(a,b){var c=O("XSRF_FIELD_NAME",void 0),d=O("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.u,g=O("XSRF_FIELD_NAME",void 0),k;b.headers&&(k=b.headers["Content-Type"]);b.Fa||J(a)&&!b.withCredentials&&J(a)!=document.location.hostname||"POST"!=b.method||k&&"application/x-www-form-urlencoded"!=k||b.u&&b.u[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=Id(e),eb(e,f),e=b.Z&&"JSON"==b.Z?JSON.stringify(e):Ub(e));if(!(c=e)&&(c=f)){a:{for(var h in f){f=!1;break a}f=!0}c=!f}!He&&c&&"POST"!=b.method&&
(He=!0,vd(Error("AJAX request with postData should use POST")));return e}
function Pe(a,b,c,d){var e=null;switch(b){case "JSON":try{var f=c.responseText}catch(g){throw d=Error("Error reading responseText"),d.params=a,wd(d),g;}a=c.getResponseHeader("Content-Type")||"";f&&0<=a.indexOf("json")&&(e=JSON.parse(f));break;case "XML":if(a=(a=c.responseXML)?Qe(a):null)e={},G(a.getElementsByTagName("*"),function(g){e[g.tagName]=Re(g)})}d&&Se(e);
return e}
function Se(a){if(Ia(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=a[b],e=new rb;if(void 0===fb){var f=null;var g=A.trustedTypes;if(g&&g.createPolicy){try{f=g.createPolicy("goog#html",{createHTML:Pa,createScript:Pa,createScriptURL:Pa})}catch(k){A.console&&A.console.error(k.message)}fb=f}else fb=f}(f=fb)&&f.createHTML(d);a[c]=e}else Se(a[b])}}
function Qe(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Re(a){var b="";G(a.childNodes,function(c){b+=c.nodeValue});
return b}
function Oe(a,b,c,d,e,f,g){function k(){4==(h&&"readyState"in h?h.readyState:0)&&b&&ud(b)(h)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var h=Ee();if(!h)return null;"onloadend"in h?h.addEventListener("loadend",k,!1):h.onreadystatechange=k;S("debug_forward_web_query_parameters")&&(a=Je(a));h.open(c,a,!0);f&&(h.responseType=f);g&&(h.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=Ie(a,e))for(var l in e)h.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&h.setRequestHeader("Content-Type","application/x-www-form-urlencoded");h.send(d);
return h}
;function Te(){for(var a={},b=u(Object.entries(Id(O("DEVICE","")))),c=b.next();!c.done;c=b.next()){var d=u(c.value);c=d.next().value;d=d.next().value;"cbrand"===c?a.deviceMake=d:"cmodel"===c?a.deviceModel=d:"cbr"===c?a.browserName=d:"cbrver"===c?a.browserVersion=d:"cos"===c?a.osName=d:"cosver"===c?a.osVersion=d:"cplatform"===c&&(a.platform=d)}return a}
;function Ue(){return"INNERTUBE_API_KEY"in N&&"INNERTUBE_API_VERSION"in N}
function ue(){return{innertubeApiKey:O("INNERTUBE_API_KEY",void 0),innertubeApiVersion:O("INNERTUBE_API_VERSION",void 0),fa:O("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),ga:O("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:O("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),ia:O("INNERTUBE_CONTEXT_HL",void 0),ha:O("INNERTUBE_CONTEXT_GL",void 0),ja:O("INNERTUBE_HOST_OVERRIDE",void 0)||"",la:!!O("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),ka:!!O("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1)}}
function te(a){a={client:{hl:a.ia,gl:a.ha,clientName:a.ga,clientVersion:a.innertubeContextClientVersion,configInfo:a.fa}};var b=window.devicePixelRatio;b&&1!=b&&(a.client.screenDensityFloat=String(b));b=O("EXPERIMENTS_TOKEN","");""!==b&&(a.client.experimentsToken=b);b=[];var c=O("EXPERIMENTS_FORCED_FLAGS",{});for(d in c)b.push({key:d,value:String(c[d])});var d=O("EXPERIMENT_FLAGS",{});for(var e in d)e.startsWith("force_")&&void 0===c[e]&&b.push({key:e,value:String(d[e])});0<b.length&&(a.request={internalExperimentFlags:b});
O("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(a.user={onBehalfOfUser:O("DELEGATED_SESSION_ID")});a.client=Object.assign(a.client,Te());return a}
function Ve(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||O("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Ba||O("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Aa:b=gc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=O("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));return d}
...
function Xe(a){a=We(a);var b=new yc;b.update(JSON.stringify(a,Object.keys(a).sort()));a=b.digest();b="";for(var c=0;c<a.length;c++)b+="0123456789ABCDEF".charAt(Math.floor(a[c]/16))+"0123456789ABCDEF".charAt(a[c]%16);return b}
;function Ye(){var a=new kd;(a=a.isAvailable()?new qd(a,"yt.innertube"):null)||(a=new ld("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new gd(a):null;this.g=document.domain||window.location.hostname}
Ye.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,C()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Jc(b))}catch(f){return}else e=escape(b);b=this.g;Lb.set(""+a,e,{U:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
Ye.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=Lb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Ye.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Lb.remove(""+a,"/",void 0===b?"youtube.com":b)};var Ze;function $e(){Ze||(Ze=new Ye);return Ze}
function af(a,b,c,d){if(d)return null;d=$e().get("nextId",!0)||1;var e=$e().get("requests",!0)||{};e[d]={method:a,request:b,authState:We(c),requestTime:Math.round(U())};$e().set("nextId",d+1,86400,!0);$e().set("requests",e,86400,!0);return d}
function bf(a){var b=$e().get("requests",!0)||{};delete b[a];$e().set("requests",b,86400,!0)}
function cf(a){var b=$e().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=We(Ve(!1));bb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),xe(a,d.method,e,{}));delete b[c]}}$e().set("requests",b,86400,!0)}}
;function df(){}
;function ef(){var a=Error.call(this,"Transaction was aborted");this.message=a.message;"stack"in a&&(this.stack=a.stack);Object.setPrototypeOf(this,ef.prototype)}
na(ef,Error);function V(a){return new L(function(b,c){function d(){c(a.error);f()}
function e(){b(a.result);f()}
function f(){a.removeEventListener("success",e);a.removeEventListener("error",d)}
a.addEventListener("success",e);a.addEventListener("error",d)})}
;function ff(a){this.f=a}
q=ff.prototype;q.add=function(a,b,c){return W(X(this,[a],"readwrite"),a).add(b,c)};
...
function gf(a,b,c){a=a.f.createObjectStore(b,c);return new hf(a)}
...
q=hf.prototype;q.add=function(a,b){return V(this.f.add(a,b))};
...
q.index=function(a){return new kf(this.f.index(a))};
q.getName=function(){return this.f.name};
function jf(a){var b=this;this.f=a;this.g=new Map;this.done=new L(function(c,d){b.f.addEventListener("complete",function(){c()});
b.f.addEventListener("error",function(){d(b.f.error)});
b.f.addEventListener("abort",function(){d(new ef)})})}
...
kf.prototype.count=function(a){return V(this.f.count(a))};
kf.prototype.get=function(a){return V(this.f.get(a))};
function lf(a,b){this.request=a;this.f=b}
function mf(a){return V(a).then(function(b){return null===b?null:new lf(a,b)})}
lf.prototype["delete"]=function(){return V(this.f["delete"]()).then(function(){})};
lf.prototype.update=function(a){return V(this.f.update(a))};function nf(a,b,c){function d(){m||(m=new ff(f.result));return m}
var e=jf;var f=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var g=c.f,k=c.blocking,h=c.g,l=c.upgrade,m;l&&f.addEventListener("upgradeneeded",function(n){if(null===n.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");var r=d(),p=new e(f.transaction);l(r,n.oldVersion,n.newVersion,p)});
g&&f.addEventListener("blocked",function(){g()});
return V(f).then(function(n){k&&n.addEventListener("versionchange",function(){k(d())});
h&&n.addEventListener("close",function(){h()});
return d()})}
function of(a,b,c){c=void 0===c?{}:c;return nf(a,b,c)}
;var pf;function qf(){return K(this,function b(){var c,d,e;return x(b,function(f){switch(f.f){case 1:if(!self.indexedDB)return f["return"](!1);sa(f);e=!1;return w(f,of("yt-idb-test-do-not-use",void 0,{blocking:function(){e=!0;c&&(c.close(),c=void 0)}}),5);
case 5:return c=f.g,w(f,of("yt-idb-test-do-not-use",c.f.version+1),6);case 6:return d=f.g,d.close(),d=void 0,f["return"](e);case 3:ua(f);if(c)try{c.close()}catch(g){}if(d)try{d.close()}catch(g){}va(f);break;case 2:return ta(f),f["return"](!1)}})})}
function rf(){return void 0!==pf?Oc(pf):new L(function(a){qf().then(function(b){pf=b;a(b)})})}
;var sf;function tf(){return K(this,function b(){return x(b,function(c){if(!sf)try{sf=of("LogsDataBase",1,{upgrade:function(d,e){1>e&&(gf(d,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).f.createIndex("newRequest",["status","authHash","timestamp"],{unique:!1}),gf(d,"sapisid"))}})}catch(d){if(!(d instanceof DOMException||d instanceof DOMError)||"VersionError"!==d.name)return vd(d),c["return"](Promise.reject(d));
sf=of("LogsDataBase")}return c["return"](sf)})})}
function uf(a){return K(this,function c(){var d,e,f,g,k;return x(c,function(h){switch(h.f){case 1:return w(h,tf(),2);case 2:return d=h.g,e=W(X(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(h,vf(),3);case 3:return f=h.g,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:f}),w(h,e.add(g),4);case 4:return k=h.g,h["return"](k)}})})}
function wf(){return K(this,function b(){var c,d,e,f,g,k,h,l;return x(b,function(m){switch(m.f){case 1:return w(m,vf(),2);case 2:return c=m.g,d=["NEW",c,0],e=["NEW",c,U()],f=IDBKeyRange.bound(d,e),w(m,tf(),3);case 3:g=m.g;k=X(g,["LogsRequestsStore"],"readwrite");var n=W(k,"LogsRequestsStore").index("newRequest").f.openCursor(f,"prev");n=mf(n);return w(m,n,4);case 4:h=m.g;l=void 0;if(null===h||void 0===h||!h.f.value){m.v(5);break}l=h.f.value;l.status="QUEUED";return w(m,h.update(l),5);case 5:return m["return"](l)}})})}
function xf(a){return K(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,tf(),2);case 2:return d=g.g,e=W(X(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:return f=g.g,f.status="QUEUED",w(g,V(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
function yf(a){return K(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,tf(),2);case 2:return d=g.g,e=W(X(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:return f=g.g,f.status="NEW",f.sendCount+=1,w(g,V(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
function zf(){return K(this,function b(){var c,d;return x(b,function(e){if(1==e.f)return w(e,tf(),2);if(3!=e.f)return c=e.g,w(e,c.count("LogsRequestsStore"),3);d=e.g;return e["return"](!d)})})}
function Af(a){return K(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,tf(),2);d=e.g;return e["return"](d["delete"]("LogsRequestsStore",a))})})}
function vf(){return K(this,function b(){var c;return x(b,function(d){if(1==d.f){df.f||(df.f=new df);var e={};var f=gc([]);f&&(e.Authorization=f,e["X-Goog-AuthUser"]=O("SESSION_INDEX",0),"INNERTUBE_HOST_OVERRIDE"in N||(e["X-Origin"]=window.location.origin),S("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in N&&(e["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));e=Oc(e);return w(d,e,2)}c=d.g;return d["return"](Xe(c))})})}
;var Bf=Wd("network_polling_interval",3E4);function Cf(){this.i=0;this.f=window.navigator.onLine;Df(this);Ef(this)}
function Ff(){Cf.f||(Cf.f=new Cf);return Cf.f}
function Gf(a){var b=Hf,c=If;Jf(a);(new L(function(d){a.g=d})).then(function(){b();
c&&(a.h=c)})}
function Ef(a){window.addEventListener("online",function(){a.f=!0;a.g&&a.g()})}
function Df(a){window.addEventListener("offline",function(){a.f=!1;a.h&&a.h()})}
function Jf(a){a.i||(Kf(a),window.navigator.onLine&&a.g&&a.g())}
function Kf(a){a.i=Yd(function(){window.navigator.onLine?(!1===a.f&&vd(Error("NetworkStatusManager missed online event.")),a.f=!0,a.g&&a.g()):(!0===a.f&&vd(Error("NetworkStatusManager missed offline event.")),a.f=!1,a.h&&a.h());Kf(a)},Bf)}
;var Lf=Wd("networkless_throttle_timeout")||100,Mf=Wd("networkless_retry_attempts")||1,Nf=0;function Of(a,b){rf().then(function(c){if(c&&!S("networkless_bypass_write")){var d={url:a,options:b,timestamp:U(),status:"NEW",sendCount:0};uf(d).then(function(e){d.id=e;e=Ff();e.f?Pf(d):Gf(e)})["catch"](function(){Pf(d);
vd(Error("Networkless Logging: Log request setting to indexedDB failed."))})}else Ne(a,b)})}
function Hf(){Nf||(Nf=Zd(function(){Pf();Nf=0;Hf()},1,Lf))}
function If(){var a=Nf;if(!isNaN(a)){var b=B("yt.scheduler.instance.cancelJob");b?b(a):window.clearTimeout(a)}Nf=0}
function Pf(a){K(this,function c(){var d=this,e,f,g,k;return x(c,function(h){switch(h.f){case 1:e=d;if(!a)return w(h,wf(),6);if(!a.id){h.v(3);break}return w(h,xf(a.id),5);case 5:a=h.g;h.v(3);break;case 6:if(a=h.g){h.v(3);break}return w(h,zf(),8);case 8:return(f=h.g)&&If(),h["return"]();case 3:if(Qf(a))g=a.options.onError?a.options.onError:function(){},k=a.options.onSuccess?a.options.onSuccess:function(){},a.options.onError=function(l,m){return K(e,function r(){return x(r,function(p){if(1==p.f)return a&&
a.id?a.sendCount<Mf?w(p,yf(a.id),6):w(p,Af(a.id),2):p.v(2);
2!=p.f&&(Nf||Gf(Ff()),g(l,m));g(l,m);p.f=0})})},a.options.onSuccess=function(l,m){return K(e,function r(){return x(r,function(p){if(1==p.f)return a&&a.id?w(p,Af(a.id),2):p.v(2);
k(l,m);p.f=0})})},Ne(a.url,a.options);
else if(wd(Error("Networkless Logging: Stored logs request expired age limit")),a.id)return w(h,Af(a.id),0);h.v(0)}})})}
...
na(Rf,Error);function Sf(a){var b=this;this.f=null;a?this.f=a:Ue()&&(this.f=ue());Yd(function(){cf(b)},5E3)}
Sf.prototype.isReady=function(){!this.f&&Ue()&&(this.f=ue());return!!this.f};
function xe(a,b,c,d){!O("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&wd(new Rf("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady())throw b=new Rf("innertube xhrclient not ready",b,c,d),vd(b),b.f=0,b;var e={headers:{"Content-Type":"application/json"},method:"POST",u:c,Z:"JSON",H:function(){d.H()},
X:d.H,onSuccess:function(p,v){if(d.onSuccess)d.onSuccess(v)},
W:function(p){if(d.onSuccess)d.onSuccess(p)},
onError:function(p,v){if(d.onError)d.onError(v)},
Ha:function(p){if(d.onError)d.onError(p)},
timeout:d.timeout,withCredentials:!0},f="",g=a.f.ja;g&&(f=g);g=a.f.la||!1;var k=Ve(g,f,d);Object.assign(e.headers,k);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var h="/youtubei/"+a.f.innertubeApiVersion+"/"+b,l={alt:"json"};a.f.ka&&e.headers.Authorization||(l.key=a.f.innertubeApiKey);h=Jd(""+f+h,l||{},!0);var m;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(m=af(b,c,k,g))){var n=e.onSuccess,r=e.W;e.onSuccess=function(p,v){bf(m);n(p,v)};
c.W=function(p,v){bf(m);r(p,v)}}try{S("use_fetch_for_op_xhr")?Ke(h,e):S("networkless_logging")&&d.retry?(e.method="POST",Of(h,e)):(e.method="POST",e.u||(e.u={}),Ne(h,e))}catch(p){if("InvalidAccessError"==p.name)m&&(bf(m),m=0),wd(Error("An extension is blocking network request."));
else throw p;}m&&Yd(function(){cf(a)},5E3)}
;var Tf=[{V:function(a){return"Cannot read property '"+a.key+"'"},
...
;function Y(a,b,c){this.l=this.f=this.g=null;this.j=Ja(this);this.h=0;this.s=!1;this.m=[];this.i=null;this.A=c;this.F={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?Sb(a.src):"https://www.youtube.com"),this.g=new Sd(b),c||(b=Xf(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+Ja(this.f)),Md[this.f.id]=this,window.postMessage){this.i=new M;Yf(this);b=R(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
this.addEventListener(d,b[d]);for(var e in Od)Zf(this,e)}}
...
q.destroy=function(){this.f.id&&(Md[this.f.id]=null);var a=this.i;a&&"function"==typeof a.dispose&&a.dispose();if(this.l){a=this.f;var b=a.parentNode;b&&b.replaceChild(this.l,a)}else(a=this.f)&&a.parentNode&&a.parentNode.removeChild(a);Ud&&(Ud[this.j]=null);this.g=null;a=this.f;for(var c in ab)ab[c][0]==a&&Cd(c);this.l=this.f=null};
q.K=function(){return{}};
function ag(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.s?a.R(b):a.m.push(b)}
q.I=function(a,b){if(!this.i.h){var c={target:this,data:b};this.i.P(a,c);Rd(this.A+"."+a,c)}};
...
" "))}null!==l&&(k[h]=l)});
c.src=R(a.g,"host")+a.L()+"?"+Ub(k);return c}
q.Y=function(){this.f&&this.f.contentWindow?this.R({event:"listening"}):window.clearInterval(this.h)};
function Yf(a){Td(a.g,a,a.j);a.h=Gd(Oa(a.Y,a));Ed(a.f,"load",Oa(function(){window.clearInterval(this.h);this.h=Gd(Oa(this.Y,this))},a))}
function $f(a,b){a.F[b]||(a.F[b]=!0,ag(a,"addEventListener",[b]))}
q.R=function(a){a.id=this.j;a.channel="widget";a=Jc(a);var b=this.g;var c=Sb(this.f.src||"");b=0==c.indexOf("https:")?[c]:b.f?[c.replace("http:","https:")]:b.h?[c]:[c,c.replace("http:","https:")];if(this.f.contentWindow)for(c=0;c<b.length;c++)try{this.f.contentWindow.postMessage(a,b[c])}catch(Q){if(Q.name&&"SyntaxError"==Q.name){if(!(Q.message&&0<Q.message.indexOf("target origin ''"))){var d=void 0,e=void 0,f=Q;e=void 0===e?{}:e;e.name=O("INNERTUBE_CONTEXT_CLIENT_NAME",1);e.version=O("INNERTUBE_CONTEXT_CLIENT_VERSION",
void 0);var g=e||{};e="WARNING";e=void 0===e?"ERROR":e;d=void 0===d?!1:d;if(f){if(S("console_log_js_exceptions")){var k=f,h=[];h.push("Name: "+k.name);h.push("Message: "+k.message);k.hasOwnProperty("params")&&h.push("Error Params: "+JSON.stringify(k.params));h.push("File name: "+k.fileName);h.push("Stacktrace: "+k.stack);window.console.log(h.join("\n"),k)}if((window&&window.yterr||d)&&!(5<=Vf)&&0!==f.f){var l=void 0,m=Ib(f);d=m.message||"Unknown Error";k=m.name||"UnknownError";h=m.lineNumber||"Not available";
var n=m.fileName||"Not available";m=m.stack||f.g||"Not available";if(f.hasOwnProperty("args")&&f.args&&f.args.length){var r=0;for(l=0;l<f.args.length;l++){var p=f.args[l],v="params."+l;r+=v.length;if(p)if(Array.isArray(p))for(var y=g,F=0;F<p.length&&!(p[F]&&(r+=Wf(F,p[F],v,y),500<r));F++);else if("object"===typeof p)for(y in y=void 0,F=g,p){if(p[y]&&(r+=Wf(y,p[y],v,F),500<r))break}else g[v]=String(JSON.stringify(p)).substring(0,500),r+=g[v].length;else g[v]=String(JSON.stringify(p)).substring(0,500),
r+=g[v].length;if(500<=r)break}}else if(f.hasOwnProperty("params")&&f.params)if(p=f.params,"object"===typeof f.params)for(l in v=0,p){if(p[l]&&(r="params."+l,y=String(JSON.stringify(p[l])).substr(0,500),g[r]=y,v+=r.length+y.length,500<v))break}else g.params=String(JSON.stringify(p)).substr(0,500);g={message:d,name:k,lineNumber:h,fileName:n,stack:m,params:g};f=Number(f.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);f=g;g=u(Tf);for(d=g.next();!d.done;d=g.next())if(d=d.value,d.O[f.name])for(h=
u(d.O[f.name]),k=h.next();!k.done;k=h.next())if(n=k.value,k=f.message.match(n.regexp)){f.params["error.original"]=k[0];h=n.groups;n={};for(m=0;m<h.length;m++)n[h[m]]=k[m+1],f.params["error."+h[m]]=k[m+1];f.message=d.V(n);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(f);if(!(Uf.has(f.message)||0<=f.stack.indexOf("/YouTubeCenter.js")||0<=f.stack.indexOf("/mytube.js"))){if(S("kevlar_gel_error_routing")){g=void 0;k=e;n=f;h={stackTrace:n.stack};n.fileName&&(h.filename=n.fileName);
...
q.aa=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Ia(a))for(var c in a)this.C[c]=a[c];break;case "infoDelivery":dg(this,a);break;case "initialDelivery":window.clearInterval(this.h);this.playerInfo={};this.C={};eg(this,a.apiInterface);dg(this,a);break;default:this.I(b,a)}};
function dg(a,b){if(Ia(b))for(var c in b)a.playerInfo[c]=b[c]}
function eg(a,b){G(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(C()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:bg(c)?this[c]=function(){this.playerInfo={};
...
na(gg,Y);gg.prototype.L=function(){return"/embed/"+R(this.g,"videoId")};
gg.prototype.K=function(){return{player:0,thumb_width:R(this.g,"thumbWidth"),thumb_height:R(this.g,"thumbHeight"),thumb_align:R(this.g,"thumbAlign")}};
...
;D("YT.PlayerState.UNSTARTED",-1);D("YT.PlayerState.ENDED",0);D("YT.PlayerState.PLAYING",1);D("YT.PlayerState.PAUSED",2);D("YT.PlayerState.BUFFERING",3);D("YT.PlayerState.CUED",5);D("YT.get",function(a){return Md[a]});
D("YT.scan",Pd);D("YT.subscribe",function(a,b,c){ad.subscribe(a,b,c);Od[a]=!0;for(var d in Md)Zf(Md[d],a)});
D("YT.unsubscribe",function(a,b,c){$c(a,b,c)});
D("YT.Player",Z);D("YT.Thumbnail",gg);Y.prototype.destroy=Y.prototype.destroy;Y.prototype.setSize=Y.prototype.setSize;Y.prototype.getIframe=Y.prototype.ma;Y.prototype.addEventListener=Y.prototype.addEventListener;Z.prototype.getVideoEmbedCode=Z.prototype.getVideoEmbedCode;Z.prototype.getOptions=Z.prototype.getOptions;Z.prototype.getOption=Z.prototype.getOption;Nd.push(function(a){a=Qd("player",a);G(a,fg)});
Nd.push(function(){var a=Qd("thumbnail");G(a,hg)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Pd();var ig=A.onYTReady;ig&&ig();var jg=A.onYouTubeIframeAPIReady;jg&&jg();var kg=A.onYouTubePlayerAPIReady;kg&&kg();}).call(this);
